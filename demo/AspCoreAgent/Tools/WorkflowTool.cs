...
{
    public class WorkflowTool : IScopedDependencie
    {
        private readonly IAgentWorkflowRunner _workflowRunner;
        private readonly DeepSeekAgent _agent;

        public WorkflowTool(IAgentWorkflowRunner workflowRunner,
            DeepSeekAgent agent)
        {
